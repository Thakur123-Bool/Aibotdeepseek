...
uploadForm.addEventListener('submit', async (e) => {
    ...
    try {
        const response = await fetch('https://big-laverna-9aipdfreader-0faed062.koyeb.app/upload_documents/', {
            method: 'POST',
            body: formData
        });
...
askBtn.addEventListener('click', async () => {
    ...
    try {
        const response = await fetch('https://big-laverna-9aipdfreader-0faed062.koyeb.app/ask_question/', {
            method: 'POST',
            headers: {
